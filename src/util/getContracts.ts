...
export const getMarketplaceContract = () => {
    ...
    const { contract: marketplace, isLoading: marketplaceLoading } = useContract(market_address, "marketplace-v3");
...
export const getNFTContract = () => {
    ...
    const { contract: nft_contract, isLoading: nftLoading } = useContract(nft_address);
