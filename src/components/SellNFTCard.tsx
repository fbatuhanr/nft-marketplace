...
const SellNFTCard: FC<SellNFTCardProps> = ({ price, onUpdatePrice, id }) => {
    ...
    const {mutate: createDirectListing, isLoading: listingLoading, error: listError} =
    ...
    return (
        <div className="relative bg-gray-800 text-white p-6 rounded-lg w-full shadow-md mt-4">
            <h1 className="text-center text-2xl font-semibold mb-2 ">Sell NFT</h1>
            ...
            {
                (roleError as unknown as boolean) || (listError as unknown as boolean)
